...
Copyright (c) 2026 r1589781959-cloud

回音（Huiyin）最初由 r1589781959-cloud 提出并实现。项目方向包括自然对话、长期记忆、多模型接入、本地优先的数据存储和主动陪伴能力。

你可以在 Apache License 2.0 的条款下使用、修改和分发本项目代码。若你基于本项目进行二次开发、发布衍生项目或公开介绍相关实现，请保留版权声明、许可证声明、NOTICE 文件，并注明原始项目来源。

原始项目地址：

https://github.com/r1589781959-cloud/Huiyin

### 引用方式

如果你在文章、项目、演示、研究或公开介绍中使用本项目，请参考仓库根目录的 `CITATION.cff` 文件进行引用。

### 额外说明

本仓库中的源代码采用 Apache License 2.0。

项目名称、Logo、品牌视觉、私有 Prompt、用户数据、API Key、部署密钥、商业配置文件、未公开项目文档，不包含在本开源许可证授权范围内，除非另有明确说明。

本项目仍处于实验阶段，不能替代真实人际关系，也不用于医疗、心理诊断、危机干预或紧急援助。
